  ...
  return (
    <div className="flex justify-center max-w-md mx-auto mt-44">
      <a href={socialProfiles.docs} target="_blank" rel="noopener noreferrer">
        <div className="w-16 h-16 md:w-12 md:h-12 m-2 rounded-xl bg-purple-darkest bg-opacity-80 flex flex-col items-center justify-center p-">
          <img src={Docs} alt="Docs" className="w-8 h-8 md:w-6 md:h-6" />
      ...
      <a href={socialProfiles.discord} target="_blank" rel="noopener noreferrer">
        <div className="w-16 h-16 md:w-12 md:h-12 m-2 rounded-xl bg-purple-darkest bg-opacity-80 flex flex-col items-center justify-center p-2">
          <img src={Discord} alt="Discord" className="w-8 h-8 md:w-6 md:h-6" />
          <div className="hidden md:block text-center text-white font-bold text-xs md:text-sm">
            Discord
          </div>
        </div>
      ...
      <a href={socialProfiles.twitter} target="_blank" rel="noopener noreferrer">
        <div className="w-16 h-16 md:w-12 md:h-12 m-2 rounded-xl bg-purple-darkest bg-opacity-80 flex flex-col items-center justify-center p-2">
          <img src={Twitter} alt="Twitter" className="w-8 h-8 md:w-6 md:h-6" />
          <div className="hidden md:block text-center text-white font-bold text-xs md:text-sm">
            Twitter
          </div>
        </div>
      ...
      <a href={socialProfiles.github} target="_blank" rel="noopener noreferrer">
        <div className="w-16 h-16 md:w-12 md:h-12 m-2 rounded-xl bg-purple-darkest bg-opacity-80 flex flex-col items-center justify-center p-2">
          <img src={Github} alt="Github" className="w-8 h-8 md:w-6 md:h-6" />
          <div className="hidden md:block text-center text-white font-bold text-xs md:text-sm">
            Github
          </div>
        </div>
